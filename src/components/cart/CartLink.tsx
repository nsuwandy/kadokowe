...
/**
 * The interest list's place in the header.
 *
 * Hidden entirely while it is empty. A permanent empty-basket icon is shop
 * furniture, and this is not a shop — it earns its place in the header only
 * once someone has actually collected something.
 */
